...
public class ConfigActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public static final String BLUETOOTH_DEVICE_KEY = "bluetooth_device_key_preference";
    public static final String NETWORK_DEVICE_KEY = "network_device_key_preference";
    public static final String NETWORK_DEVICE_IP = "device_ip_preference";
    public static final String NETWORK_DEVICE_PORT = "device_port_preference";
    ...
    public static int getObdUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs.
                getString(ConfigActivity.OBD_UPDATE_PERIOD_KEY, "6"); // 4 as in seconds
        int period = 6000; // by default 4000ms
    ...
    public static ArrayList<ObdCommand> getObdCommands(SharedPreferences prefs) {
        ...
        for (int i = 0; i < cmds.size(); i++) {
            ...
            boolean selected = prefs.getBoolean(commandName  , true);
            if (selected)
                ucmds.add(cmd);
        }
        return ucmds;
    ...
    /*
     * Read preferences resources avaailable at res/xml/preferences.xml
     */
